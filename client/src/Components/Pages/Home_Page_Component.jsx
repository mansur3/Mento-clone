...
export const Home_Component = ({ course }) => {
  return (
    <div className="HPCmain" style={{ backgroundColor: "white", marginTop : "-50px" }}>
      <div style={{ maxWidth: 430, maxHeight: 398, overflow: "hidden" }}>
        <div
          style={{
            backgroundImage: `url('${course.sampleImage}')`,
            maxWidth: "100%",
          ...
          className="hover"
        >
          <div style={{ width: "98%", height: 240 }}></div>
        </div>
        <div>
          {" "}
          <img className="playbutton" src="Play button.svg" alt=""></img>
        </div>
        ...
        <div className="HPC01">
          ...
          <div className="HPC02">
            <p style={{ marginLeft: "-30px" }} className="HPC01number">
              {course.totalVideo}
            </p>
